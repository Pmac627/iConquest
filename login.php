...
if(isset($_POST['submit']))
{
	...
	if(isset($_POST['username'], $_POST['pass']))
	{
		...
		{
			// Redirect them to the error page
			header("Location: error_page.php?error=35");
		}
...
else
{
	...
	<table class='main'>
		...
		<tr>
			<td class='link' colspan='4'><a class='link' href ='forgot_password.php'>Forgot Your Password?</a></td>
		</tr>
		<tr>
