...
$mod_admin = 3;
$route = '../';
$page_title_name = 'Game Version Information';
...
<table class='main'>
	<tr>
		<th class='form_head'>Version Overviews</th>
	</tr>
	<?php
	$page = 2;
	$ID_admin = 18;
	$sql = "SELECT title, post_date, body FROM mod_admin_post WHERE page='$page' AND ID_mod_admin='$ID_admin' ORDER BY ID_post DESC";
